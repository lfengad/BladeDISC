...
private:
    ...
    hipFunction_t GetFunc(const std::string& func_name="default_function_kernel0") const;
    ...
    const LaunchParamConfig launch_param_config_;
    ThreadWorkLoad wl_;
...
public:
    ...
    bool Launch(se::Stream* stream, void* packed_args, 
        size_t packed_nbytes, void** kernelParams=nullptr
        // ,
